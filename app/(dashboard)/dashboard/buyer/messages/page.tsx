...
const conversations = [
  { id: "1", name: "Premium Homes", lastMsg: "The property is available for a site visit", time: "10 min ago", unread: 1 },
  { id: "2", name: "Hyderabad Realtors", lastMsg: "Sure, I will send you the floor plan", time: "2 hours ago", unread: 0 },
];
    ...
    <DashboardShell role="buyer">
      <div className="space-y-6">
        <div>
          ...
          <p className="text-slate-500 mt-1">Chat with property providers</p>
        </div>
        <Card>
